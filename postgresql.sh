...
# -*- coding: utf-8 -*-
# PostgreSQL
POSTGRES_PS=$(whiptail --title "Пароль для базы данных PostgreSQL" --inputbox "Введите пароль для базы данных PostgreSQL и нажмите Ok для продолжения." 10 60 3>&1 1>&2 2>&3)
exitstatus=$?
